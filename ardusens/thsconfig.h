...
#define MIN_BATTERY_VOLTAGE      3600L

// voltage offset in mV added to MIN_BATTERY_VOLTAGE for battery good state during battery bad condition (hysteresis)
#define BATTERY_VOLTAGE_HYSTERESIS 400L
